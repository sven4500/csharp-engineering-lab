...
namespace CoffeeShop
{
    class ManagerStaffModel
    {
        ...
        private readonly XmlAdapter<StaffRecord> xmlAdapter = new XmlAdapter<StaffRecord>(
            new[] { "Id", "LastName", "FirstName", "MiddleName", "ContactNumber", "Position", "EmploymentDate" },
            (row) =>
            {
